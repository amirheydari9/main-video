...
//         media.volume = 0
//         input_volume.style.background = `linear-gradient(90deg,${progressColor}  1%, #FFFFFF33 0%)`;
//     }
// });
//
// volume_icon.addEventListener("click", function () {
//     lastVal = input_volume.value
//     mute_icon.style.display = "flex";
//     volume_icon.style.display = "none";
...
//         volume_icon.style.display = "flex";
//         mute_icon.style.display = "none";
//         input_volume.style.background = `linear-gradient(90deg, ${progressColor}  50% , #FFFFFF33 0%)`;
...
//         input_volume.value = lastVal
//         media.volume = input_volume.value / 100;
//
//     }
//
// });
...
// let chileElm = document.querySelector("#chileElm");
...
//         video_theater.style.margin = "15px 0 0";
//         slider_section.style.display = "none";
//         video_theater.setAttribute("href", "theater")
//         return;
//     }
//     default_palyer.insertBefore(video_theater.lastElementChild, chileElm);
//     video_theater.innerHTML = '';
//     slider_section.style.display = "block";
//     video_theater.style.margin = "0";
//
// })
//
// // const rfs =
...
//     media.addEventListener('canplay',async function (){
//         video_time.textContent = await getTime(media.duration)
//     });
// }, false);
...
function playanimation() {
    ...
    animatedBtn.classList.remove("animationsTow");
    animatedBtn.classList.toggle("animations");
    animatedBtn.firstElementChild.src = './img/play.svg';
}
...
function pauseanimation() {
    ...
    animatedBtn.classList.toggle("animations");
    animatedBtn.classList.add("animationsTow");
    animatedBtn.firstElementChild.src = './img/pause.svg';
}
